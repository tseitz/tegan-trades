...
# Re-exported: engine assembly moved to its own module — it is the impure composition root and
# every probe in the repo needs it — but these names remain part of this CLI's surface for
# callers and tests that reach for them here.
from oracle.assemble import (
    CONFIG_DIR,
    REPO_ROOT,
    BuildStats,
    build_candidates,
